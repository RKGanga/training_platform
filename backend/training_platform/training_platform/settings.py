...
SECRET_KEY = 'django-insecure-*n$pmh^wjofg77qw4$%)k9+@+l1j1xp-_0kunui2@k2++x94ci'
...
EMAIL_PORT = 587
EMAIL_USE_TLS = True
EMAIL_HOST_USER = 'hr@sunvivatechnologies.com'
EMAIL_HOST_PASSWORD = 'Sand!@1987.'
DEFAULT_FROM_EMAIL = 'hr@sunvivatechnologies.com'
